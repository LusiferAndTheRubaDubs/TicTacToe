$(document).ready(function() {
	$(".tile").click(function () {
		...
		$.ajax({
			type: "POST",
			url: "http://mighty-escarpment-3897.herokuapp.com/playerMove",
			traditional: true,
			data: 'tile=' + tile,
	...
	$("#again").click(function () {
		...
		$.ajax({
			type: "GET",
			url: "http://mighty-escarpment-3897.herokuapp.com/playagain",
			traditional: true,
			success: function (data) {
				location.reload();
			},
		...
		$.ajax({
			type: "GET",
			url: "http://mighty-escarpment-3897.herokuapp.com/oneplayer",
			traditional: true,
			success: function (data) {
				location.reload();
			},
		...
		$.ajax({
			type: "GET",
			url: "http://mighty-escarpment-3897.herokuapp.com/twoplayer",
			traditional: true,
			success: function (data) {
				location.reload();
			},
